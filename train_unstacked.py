...
from path_rnn_unstacked import PathRNN
from tensor_generator_unstacked import get_indexed_paths, get_labels
...
if __name__ == '__main__':
    dataset = pd.read_json('dummy_dataset.json').loc[:3]
